...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="models/vits2_base.ckpt",
        help="Path to trained model checkpoint",
    )
    parser.add_argument(
        "--config_path",
        type=str,
        default="configs/models/vits2_base.yaml",
    ...
    # Audio arguments
    parser.add_argument(
        "--sample_rate", type=int, default=22050, help="Output sample rate"
    )
...
def main():
    ...
    if args.reference_audio:
        ...
        cloner = VoiceCloner(
            model_path=args.model_path, config_path=args.config_path, device=device
        )
